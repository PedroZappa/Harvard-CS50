...
![Cypher text Image](/IMG/L2/cs50Week2Slide008.png)
...
![Above code in Binary](/IMG/L2/cs50Week2Slide012.png)
...
- Compiling involves major steps, including the following:
  ...
  ![Assembly Conversion Visualization](/IMG/L2/cs50Week2Slide033.png)
  ...
  ![Assembly into Binary Conversion Visualization](/IMG/L2/cs50Week2Slide038.png)
  ...
  ![Linking Visualization](/IMG/L2/cs50Week2Slide049.png)
...
![Mario](/IMG/L2/cs50Week2Slide061.png)
...
- To utilize this debugger, first set a breakpoint by clicking to the left of a line of your code, just to the left of the line number. When you click there, you will see a red dot appearing. Imagine this as a stop sign, asking the compiler to pause such that you can consider what’s happening in this part of your code.
    ...
    ![Debugger](/IMG/L2/cs50Week2Debugging.png)
...
![Rubber Duck Debugger](/IMG/L2/cs50Week2Slide070.png)
...
![Memory](/IMG/L2/cs50Week2Slide084.png)

- Physically, on the memory of your computer, you can imagine how specific types of data are stored on your computer. You might imagine that a 1, which only requires 1 byte of memory, may look as follows:

![Memory2](/IMG/L2/cs50Week2Slide087.png)

- Similarly, an `int`, which requires 4 bytes might look as follows:

![Memory3](/IMG/L2/cs50Week2Slide088.png)
...
![Memory4](IMG/L2/cs50Week2Slide098.png)
...
![String](/IMG/L2/cs50Week2Slide116.png)

- Imagining this in decimal, your array would look like the following:

![String2](/IMG/L2/cs50Week2Slide117.png)
...
![String3](/IMG/L2/cs50Week2Slide126.png)
...
Notice that this code iterates through each value in the string. The program looks at each character. If the character is lowercase, it subtracts the value 32 from it to convert it to lowercase.

- Recalling our previous work from last week, you might remember this ASCII values chart:

![ASCII](/IMG/L2/cs50Week2Slide120.png)
...
Therefore, using the syntax of this program, executing `./greet David` would result in the program saying 
...
![Cipher](/IMG/L2/cs50Week2Slide153.png)
